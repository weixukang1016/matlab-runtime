...
RUN wget MCR_${MCR_VERSION}.zip https://ssd.mathworks.com/supportfiles/downloads/R2017a/deployment_files/R2017a/installers/glnxa64/MCR_R2017a_glnxa64_installer.zip

# Add MCR intall files
#ADD MCR_${MCR_VERSION}.zip /mcr-install/mcr.zip
ADD MCR_${MCR_VERSION}.zip /mcr-install
